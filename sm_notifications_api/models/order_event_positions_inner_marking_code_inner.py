...
class OrderEventPositionsInnerMarkingCodeInner(BaseModel):
    """
    OrderEventPositionsInnerMarkingCodeInner
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Код маркировки")
