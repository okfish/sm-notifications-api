...
class TestNotificationsRequestEvent(unittest.TestCase):
    """NotificationsRequestEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationsRequestEvent:
        """Test NotificationsRequestEvent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationsRequestEvent`
        """
        model = NotificationsRequestEvent()
        if include_optional:
            return NotificationsRequestEvent(
    ...
    def testNotificationsRequestEvent(self):
        """Test NotificationsRequestEvent"""
